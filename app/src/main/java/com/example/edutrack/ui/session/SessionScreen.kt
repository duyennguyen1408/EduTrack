...
import com.example.edutrack.ui.components.SubjectListBottomSheet
import com.example.edutrack.ui.components.studySessionsList
import com.example.edutrack.ui.theme.Red
import com.example.edutrack.util.Constants.ACTION_SERVICE_CANCEL
import com.example.edutrack.util.Constants.ACTION_SERVICE_START
import com.example.edutrack.util.Constants.ACTION_SERVICE_STOP
...
@Destination(
    deepLinks = [
        DeepLink(
            ...
            uriPattern = "edu_track://dashboard/session"
        )
    ]
)
@Composable
